...
def home(request):
    ...
    # Add members and events querysets so templates can use {{ members.count }} and {{ events.count }}
    try:
    ...
    # Build simple events JSON for client-side calendar (same shape used by hoo/home)
    try:
        events_json = []
