...
urlpatterns = [
    ...
    path('vericert/', views.VERICERT, name='vericert'),
    ...
    path('hoo/Event/Q1Counts/<int:id>/', hoo_views.GET_EVENT_Q1_COUNTS, name='get_event_q1_counts'),
    path('hoo/Event/Q2Counts/<int:id>/', hoo_views.GET_EVENT_Q2_COUNTS, name='get_event_q2_counts'),
    path('hoo/Event/Q3Counts/<int:id>/', hoo_views.GET_EVENT_Q3_COUNTS, name='get_event_q3_counts'),
    path('hoo/Event/NPSCounts/<int:id>/', hoo_views.GET_EVENT_NPS_COUNTS, name='get_event_nps_counts'),
    ...
    path('hoo/Event/Attendees', hoo_views.LIST_ATTENDEES, name='list_attendees'),
    ...
    path('hoo/Certificate/Generate/<int:member_id>/', hoo_views.MEMBERSHIP_CERTIFICATE, name='generate_certificate'),
